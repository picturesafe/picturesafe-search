...
You also need to have installed https://maven.apache.org/[Apache Maven]. The picturesafe-search project is currently developed using Maven 3.6, but other 3.x
versions could work also (not tested).
