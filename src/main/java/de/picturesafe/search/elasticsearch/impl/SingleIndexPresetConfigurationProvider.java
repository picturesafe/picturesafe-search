...
public class SingleIndexPresetConfigurationProvider implements IndexPresetConfigurationProvider {

    private final IndexPresetConfiguration indexPresetConfiguration;

    public SingleIndexPresetConfigurationProvider(IndexPresetConfiguration indexPresetConfiguration) {
