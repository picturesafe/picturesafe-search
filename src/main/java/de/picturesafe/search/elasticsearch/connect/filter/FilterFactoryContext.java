...
public class FilterFactoryContext {
    ...
    public FilterFactoryContext(MappingConfiguration mappingConfiguration) {
        this.mappingConfiguration = mappingConfiguration;
    }

    public FilterFactoryContext(MappingConfiguration mappingConfiguration, boolean nestedQuery) {
        this.mappingConfiguration = mappingConfiguration;
